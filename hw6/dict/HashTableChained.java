...
public class HashTableChained implements Dictionary {
	...
	/**
	 * Find a prime number around a given number primeNear(int k) Always return
	 * a number that is prime and >= K
	 */
	...
	public static void main(String[] argv) {
		...
		System.out.println("After inserting " + 1 + " elements");
